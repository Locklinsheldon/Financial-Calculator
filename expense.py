...
def expense(): #The income function
    try:
        ...
        with open('money_tracking.csv', 'r+', newline='') as csvfile:
            ...
            # Ask for new expense and reason
            while True:
                try:
                    new_expense = int(input('How much money did you lose?: '))
                    reason = input(f'How did you lose ${new_expense} dollars?: ')
                    ...
                    # Add the new expense to the existing money value
                    updated_money = money - new_expense
